              ...
              <div class="card borde-0 shadow-lg my-4">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" value="<?php echo e(old('name')); ?>" class="<?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" value="<?php echo e(old('sku')); ?>" class="<?php $__errorArgs = ['sku'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" value="<?php echo e(old('price')); ?>" class="<?php $__errorArgs = ['price'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" placeholder="Enter Description" name="description" cols="30" rows="5"><?php echo e(old('description')); ?></textarea>
                    </div>
                    <div class="mb-3">
...
</html><?php /**PATH C:\xampp\htdocs\laravel11crud\resources\views/products/create.blade.php ENDPATH**/ ?>